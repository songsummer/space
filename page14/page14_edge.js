...
"stage": {
    ...
    content: {
            ...
            },
            {
                id: 'Symbol_eyes',
                type: 'rect',
                rect: ['263', '492','auto','auto','auto', 'auto']
            },
            {
                id: 'Symbol_eyesCopy',
                type: 'rect',
...
"Symbol_eyes": {
    ...
    timelines: {
        "Default Timeline": {
            ...
            autoPlay: true,
            timeline: [
                { id: "eid3", tween: [ "style", "${_eyes}", "clip", [42,45,42,0], { valueTemplate: 'rect(@@0@@px @@1@@px @@2@@px @@3@@px)', fromValue: [0,45,42,0]}], position: 500, duration: 126 },
                { id: "eid6", tween: [ "style", "${_eyes}", "clip", [0,45,42,0], { valueTemplate: 'rect(@@0@@px @@1@@px @@2@@px @@3@@px)', fromValue: [42,45,42,0]}], position: 656, duration: 94 }            ]
        }
    }
},
"Symbol_yuns": {
